...
typedef TMap<FVoxelGrassInfoIndex, UHierarchicalInstancedStaticMeshComponent*> FVoxelGrassMeshes;
...
public:
	...
	void MoveGrassToArray(TArray<UHierarchicalInstancedStaticMeshComponent*>& OutGrass);
public:
	void ResetAlpha();
...
private:	
	...
	void DestroyGrass();
	void ApplyGrassAndActorsFromMeshTask();
};
