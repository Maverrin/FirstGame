...
public:
	...
	FAsyncOctreeBuilderTask(uint8 LOD, uint8 LODLimit, const FIntBox& WorldBounds);
	
public:
	void Init(const TArray<FIntBox>& CameraBounds, TSharedPtr<FVoxelChunkOctree> Octree, const FRichCurve* LODCurve);
	void Reset();
...
private:
	...
	TUniquePtr<FRichCurve> LODCurve;
	const uint8 LOD;
