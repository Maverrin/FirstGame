...
#define LOCTEXT_NAMESPACE "MaterialExpressionBlendMaterialAttributesBarycentric"

UMaterialExpressionBlendMaterialAttributesBarycentric::UMaterialExpressionBlendMaterialAttributesBarycentric(const FObjectInitializer& ObjectInitializer)
