...
public:
	...
	virtual bool IsPreviewing() const { return false; }
	...
	VOXELEDITOR_API int32 GetInputPinIndex(const UEdGraphPin* Pin) const;
	VOXELEDITOR_API int32 GetOutputPinIndex(const UEdGraphPin* Pin) const;
