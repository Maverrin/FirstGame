...
class VOXELEDITOR_API FVoxelGraphEditorUtilities
{
public:
	...
	static TSharedPtr<class IVoxelGraphEditorToolkit> GetIVoxelEditorForObject(const UObject* ObjectToFocusOn);
	
private:
	FVoxelGraphEditorUtilities() {}
};
