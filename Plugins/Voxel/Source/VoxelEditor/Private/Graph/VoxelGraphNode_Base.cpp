...
void UVoxelGraphNode_Base::ReconstructNode()
{
	...
	{
		if (PinIndex < NewInputPins.Num() && NewInputPins[PinIndex]->PinType == OldInputPins[PinIndex]->PinType)
		{
	...
	{
		if (PinIndex < NewOutputPins.Num() && NewOutputPins[PinIndex]->PinType == OldOutputPins[PinIndex]->PinType)
		{
