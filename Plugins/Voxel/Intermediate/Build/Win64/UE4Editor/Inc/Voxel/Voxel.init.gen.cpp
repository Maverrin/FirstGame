...
void EmptyLinkFunctionForGeneratedCodeVoxel_init() {}
	VOXEL_API UFunction* Z_Construct_UDelegateFunction_Voxel_OnClientConnection__DelegateSignature();
	...
	UPackage* Z_Construct_UPackage__Script_Voxel()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_Voxel_OnClientConnection__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_Voxel_OnWorldLoaded__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_Voxel_VoxelPartOnLoaded__DelegateSignature,
			};
